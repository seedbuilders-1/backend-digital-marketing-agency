...
exports.getAllRequests = async (req, res) => {
  try {
    ...
    if (requests.length === 0)
      return sendError(res, 404, "Service requests not found");
    return sendSuccess(
      res,
      200,
      requests,
...
exports.getRequest = async (req, res) => {
  try {
    ...
    return sendError(
      res,
      500,
      "Could not fetch your Service request",
      err.message
    );
  }
};
...
exports.createRequest = async (req, res) => {
  try {
    ...
    if (!message || !service_id || plan_id)
      return sendError(
        res,
        400,
        "All fields are required - message, service_id, plan_id"
      );
    ...
    if (!newRequest)
      return sendError(res, 404, "Could not create Service request");
    ...
    return sendError(
      res,
      500,
      "Could not create your Service request",
      err.message
    );
  }
};
