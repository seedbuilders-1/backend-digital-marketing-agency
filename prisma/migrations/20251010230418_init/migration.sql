...
CREATE TABLE `Organisation` (
    ...
    UNIQUE INDEX `Organisation_user_id_key`(`user_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Invoice` (
    ...
    UNIQUE INDEX `Invoice_payment_reference_key`(`payment_reference`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Milestone` (
    ...
    `deliverable_file_url` VARCHAR(191) NULL,
    `deliverable_file_name` VARCHAR(191) NULL,
    `deliverable_link_url` VARCHAR(191) NULL,
